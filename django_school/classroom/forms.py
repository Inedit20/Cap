...
from classroom.models import (Collaboration_connaissances,Idee, Collaboration_actuelle,Comment_display,Chaine, Equipe, Quiz, Capteur,  Student, TypeCapteur , Domaine, Subject, User, Profile, Comment)
...
class StudentSignUpForm(UserCreationForm):
    ...
    chaine = forms.ModelMultipleChoiceField(
        ...
        widget=forms.CheckboxSelectMultiple,
        required=True,
        label='chaînes de connaissances',
...
class ProjetForm(forms.ModelForm):
    ...
    subject = forms.ModelMultipleChoiceField(
        ...
        widget=forms.CheckboxSelectMultiple,
        required=True,
        label = 'Disciplines scientifiques nécessaires au projet  ',
    )
...
class CapteurForm(forms.ModelForm):
    ...
    class Meta:
          model = Capteur
          fields = ['nom_capteur', 'description_projet','subject', 'type_evt', 'domaine', 'technologie_utilisee','link_1','link_2','link_3','file_1', 'file_2', 'file_3','confidentalite',]
