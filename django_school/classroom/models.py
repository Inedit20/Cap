...
class Capteur(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, null= True)
    slug = models.SlugField(max_length=140, unique=True)
    link_1= models.URLField(blank=True, max_length=2000, verbose_name= u"Lien 1 ",)
    link_2= models.URLField(blank=True, max_length=2000, verbose_name= u"Lien 2 ")
    link_3= models.URLField(blank=True, max_length=2000, verbose_name= u"Lien 3 ")
    link_4= models.URLField(blank=True, max_length=2000, verbose_name= u"Lien 4 ")
...
class Idee(models.Model):
    qid = models.AutoField(primary_key=True)
    question_title = models.CharField(max_length=100, verbose_name= u" Titre du concept")
    question_text = RichTextField(blank=True, null=True, verbose_name= u" Description")
    date_posted = models.DateTimeField(auto_now_add=True)
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='idees')
    slug = models.SlugField(max_length=40)
    file_1 = models.FileField(upload_to='images/',verbose_name=u"Télécharger votre fichier 1 ", null=True, blank=True)
    file_2 = models.FileField(upload_to='images/',verbose_name=u"Télécharger votre fichier 2 ", null=True, blank=True)
    file_3 = models.ImageField(upload_to='images/',verbose_name=u"Figure associée au produit ", null=True, blank=True)
